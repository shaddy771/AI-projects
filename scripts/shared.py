...
BLOG_POSTS = [
    {"slug": "chto-delat-zaklinil-zamok", "title": "Что делать, если заклинил замок: пошаговая инструкция", "desc": "Замок не поворачивается, ключ не выходит — что делать самостоятельно и когда звать мастера.", "date": "2026-08-15", "read": "5 мин"},
    {"slug": "kak-vybrat-zamok-dlya-dveri", "title": "Как выбрать замок для входной двери в 2026 году", "desc": "Сравнение цилиндровых и сувальдных замков. Cisa, Kale, Гардиан — что лучше для квартиры.", "date": "2026-08-10", "read": "7 мин"},
    {"slug": "slomalsya-klyuch-v-zamke", "title": "Сломался ключ в замке — можно ли извлечь самому?", "desc": "Почему ломаются ключи, как не усугубить поломку и когда нужен профессионал.", "date": "2026-08-05", "read": "4 мин"},
    {"slug": "skolko-stoit-vskrytie-zamka", "title": "Сколько стоит вскрытие замка в Могилёве в 2026", "desc": "Актуальные цены на вскрытие дверей, авто и сейфов. От чего зависит стоимость.", "date": "2026-07-28", "read": "6 мин"},
    {"slug": "vskrytie-avto-bez-povrezhdeniy", "title": "Вскрытие автомобиля без повреждений: как это работает", "desc": "Методы открытия авто профессионалами. Почему не стоит ломать стекло.", "date": "2026-07-20", "read": "5 мин"},
    {"slug": "kak-zamenit-lichinku-zamka", "title": "Как заменить личинку замка своими руками и когда лучше вызвать мастера", "desc": "Пошаговая замена личинки. Инструменты, типичные ошибки, стоимость работ.", "date": "2026-07-12", "read": "8 мин"},
]
